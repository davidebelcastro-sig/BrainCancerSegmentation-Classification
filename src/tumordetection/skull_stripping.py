...
def analize(path):
    ...
    for el in contours:
       ...
       # if cv2.contourArea(el) < (0.0018*img.shape[0]*img.shape[1]):
    ...
    if cv2.contourArea(c) < 5000:  #VOGLIO UN VALORE CHE DIPENDE DALLE DIMENSIONI DI EXTERNAL
